...
class Participant(BaseModel):
    ...
    closest_future_date: datetime = Field(
        default=None,
    ...
    system_last_modified: datetime = Field(
...
#         default=None, alias="Vrdeltagerperson", description="Vrdeltagerperson"
#     )

# class ParticipantObject(BaseModel):
#     participant: Participant = Field(default=None, alias="Vrdeltagerperson")


# class ParticipantsSource(BaseModel):
#     source: ParticipantObject = Field(default=None, alias="_source")


# class Participants(BaseModel):
#     values: list[ParticipantsSource] = Field(
#         default=None, alias="hits", description="hits"
#     )
